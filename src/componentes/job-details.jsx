          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: job.public_job_desc || job.description }}
              />
            </div>
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-600">
                {Array.isArray(job.details.responsibilities) ? (
                  job.details.responsibilities.map((resp, idx) => <li key={idx}>{resp}</li>)
                ) : (
            ...
            <div className="mt-4">
              <p className="text-gray-600">
                <strong>Total Experience:</strong> {job.experience}
              </p>
              <p className="text-gray-600">
          ...
          >
            ...
            <div className="">
              ...
              <form className="space-y-2" ref={form} onSubmit={sendEmail}>
                ...
                <div>
                  <label className="block text-gray-600 text-sm font-medium">Applying for Company</label>
                  <input
